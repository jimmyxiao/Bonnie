...
public class FileDataFormat {
    ...
    public static long buf8ToLong(byte [] buf, int offset, boolean bIntel)
    {
        ...
        return bIntel ? (byteToLong(buf[offset]) + (byteToLong(buf[offset + 1]) << 8) + (byteToLong(buf[offset + 2]) << 16) + (byteToLong(buf[offset + 3]) << 24)+ (byteToLong(buf[offset + 4]) << 32)+ (byteToLong(buf[offset + 5]) << 40)+ (byteToLong(buf[offset + 6]) << 48)+ (byteToLong(buf[offset + 7]) << 56)) :
                (byteToLong(buf[offset + 7]) + (byteToLong(buf[offset + 6]) << 8) + (byteToLong(buf[offset + 5]) << 16) + (byteToLong(buf[offset + 4]) << 24) + (byteToLong(buf[offset + 3]) << 32) + (byteToLong(buf[offset + 2]) << 40) + (byteToLong(buf[offset + 1]) << 48) + (byteToLong(buf[offset]) << 56)  );
    }
    ...
    public static void LongToBuf6(long val, byte [] buf, int offset) // WORD
    {
