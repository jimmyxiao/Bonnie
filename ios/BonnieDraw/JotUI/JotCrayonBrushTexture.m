...
#import "JotCrayonBrushTexture.h"
#import "JotSharedBrushTexture.h"

@implementation JotCrayonBrushTexture
...
#pragma mark - Singleton
static JotCrayonBrushTexture *_instance = nil;
...
+ (JotBrushTexture *)sharedInstance {
    if (!_instance) {
        _instance = [[JotCrayonBrushTexture alloc] init];
    }
    return _instance;
}
...
- (JotSharedBrushTexture *)brushTexture {
    ...
    if (!texture) {
        texture = [[JotSharedBrushTexture alloc] initWithImage:[UIImage imageNamed:@"Crayon"]];
