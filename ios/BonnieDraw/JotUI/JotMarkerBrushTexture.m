...
#import "JotMarkerBrushTexture.h"
#import "JotSharedBrushTexture.h"

@implementation JotMarkerBrushTexture
...
#pragma mark - Singleton
static JotMarkerBrushTexture *_instance = nil;
...
+ (JotBrushTexture*)sharedInstance {
    if (!_instance) {
        _instance = [[JotMarkerBrushTexture alloc] init];
    }
    return _instance;
}
...
- (JotSharedBrushTexture*)brushTexture {
    ...
    if (!texture) {
        texture = [[JotSharedBrushTexture alloc] initWithImage:[UIImage imageNamed:@"Marker"]];
