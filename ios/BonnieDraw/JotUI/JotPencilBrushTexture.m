...
#import "JotPencilBrushTexture.h"
#import "JotSharedBrushTexture.h"

@implementation JotPencilBrushTexture
...
#pragma mark - Singleton
static JotPencilBrushTexture *_instance = nil;
...
+ (JotBrushTexture *)sharedInstance {
    if (!_instance) {
        _instance = [[JotPencilBrushTexture alloc] init];
    }
    return _instance;
}
...
- (JotSharedBrushTexture *)brushTexture {
    ...
    if (!texture) {
        texture = [[JotSharedBrushTexture alloc] initWithImage:[UIImage imageNamed:@"Pencil"]];
