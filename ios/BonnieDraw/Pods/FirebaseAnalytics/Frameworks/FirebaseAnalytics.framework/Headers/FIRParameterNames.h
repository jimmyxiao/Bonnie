...
///     };
/// </pre>
static NSString *const kFIRParameterLevelName
NS_SWIFT_NAME(AnalyticsParameterLevelName) =
        @"level_name";
...
///     };
/// </pre>
static NSString *const kFIRParameterSuccess
NS_SWIFT_NAME(AnalyticsParameterSuccess) = @"success";
