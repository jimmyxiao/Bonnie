...
public class TTGlyph {
	...
	private ArrayList<Integer> m_endPtsOfContours = new ArrayList<Integer>();
	private ArrayList<Integer> m_instructions = new ArrayList<Integer>();
	private ArrayList<Integer> m_flags = new ArrayList<Integer>();
	private ArrayList<Integer> m_glyfIndeces = new ArrayList<Integer>();
	private ArrayList<Integer> m_arg1s = new ArrayList<Integer>();
	private ArrayList<Integer> m_arg2s = new ArrayList<Integer>();
