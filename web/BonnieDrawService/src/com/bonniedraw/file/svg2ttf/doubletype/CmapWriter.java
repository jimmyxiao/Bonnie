...
public class CmapWriter extends FontFormatWriter {
	...
	private ArrayList<Long> m_unicodes = new ArrayList<Long>();
	private ArrayList<Long> m_startCodes = new ArrayList<Long>();
	private ArrayList<Long> m_endCodes = new ArrayList<Long>();
	private Hashtable<Long, Long> m_unicode2glyph = new Hashtable<Long, Long>();
	private ArrayList<TTUnicodeRange> m_unicodeRanges = new ArrayList<TTUnicodeRange>();
	private ArrayList<Long> m_idDeltas = new ArrayList<Long>();
	private ArrayList<Long> m_idRangeOffsets = new ArrayList<Long>();
	...
	public void addUnicodeRange(TTUnicodeRange a_range) {
	    if(!m_unicodeRanges.contains(a_range))
