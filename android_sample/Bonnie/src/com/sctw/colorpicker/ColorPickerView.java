...
public class ColorPickerView extends View{
	...
	private void drawSatValPanel(Canvas canvas){
		...
		if (mValShader == null) {
			//mValShader = new LinearGradient(rect.left, rect.top, rect.right, rect.bottom,0xffffffff, 0xff000000, TileMode.CLAMP);
			mValShader = new LinearGradient(rect.left, rect.top, rect.left, rect.bottom,0xffffffff, 0xff888888, TileMode.CLAMP);
		}		
	...
	private Point satValToPoint(float sat, float val){
		...
		p.y = (int) ((1f - val) * height * 2+ rect.top);
